...
vector<vector<pair<int, int>>> deliveryMap = {
    ...
    {{0, 2}, {5, 1}},                 //  1  (ACB)
    {{0, 3}, {3, 1}},                 //  2  (FCSE)
    {{0, 5}, {4, 2}, {5, 2}, {2, 1}}, //  3  (H11 and H12)
    {{3, 2}, {5, 2}},                 //  4  (H10 , H9, H1 and H2)
    {{0, 4}, {1, 1},{3,2} ,{4, 2}}          //  5  (H3, H4, H5, H6 and H8)
...
int main()
{
    ...
    // setting the name
    myPizzaShop->shopName = "Hot n Spicy";

    // setting the address
    myPizzaShop->address = "GIKI Topi, Swabi";
